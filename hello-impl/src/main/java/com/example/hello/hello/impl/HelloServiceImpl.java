...
import com.example.hello.hello.api.GreetingMessage;
import com.example.hello.hello.api.HelloService;
import com.example.hello.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public ServiceCall<NotUsed,String> getAPoem(String id){
    return request -> {
      EntityRef<HelloCommand> ref = clusterSharding.entityRefFor(HelloAggregate.ENTITY_TYPE_KEY, id);
      return ref.
              <HelloCommand.Poem>ask(repltTo -> new GetPoem(id,repltTo),askTimeout)
              .thenApply(poem -> poem.message);     };
  }
  @Override
  ...
  @Override
  public Topic<com.example.hello.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.example.hello.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.example.hello.hello.api.HelloEvent.GreetingMessageChanged(
